...
func (x *VoteExtension) GetValidatorId() uint64 {
	if x != nil {
...
func (x *VoteExtension) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *BlockContext) GetVoteExtensions() []*VoteExtension {
	if x != nil {
...
func (x *ValidateTxResponse) GetPriority() uint64 {
	if x != nil {
		return x.Priority
	}
	return 0
...
func (x *QueryResponse) GetHeight() uint64 {
	if x != nil {
		return x.Height
	}
	return 0
...
func file_proto_abci_proto_init() {
	...
	file_proto_abci_proto_msgTypes[11].OneofWrappers = []any{
